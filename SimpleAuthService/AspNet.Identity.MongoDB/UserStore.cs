...
namespace AspNet.Identity.MongoDB
{
        ...
        where TUser:IdentityUser
    {
        ...
        public virtual Task<TUser> FindByRegistrationNumberAsync(string registrationNumber)
        {
            //var filter = Builders<TUser>.Filter.And(
            //    Builders<TUser>.Filter.Eq("Vehicles.RegistrationNo", registrationNumber),
            //    Builders<TUser>.Filter.Eq("Vehicles.VehicleName", vehicleName)
            //    );

            var filter = Builders<TUser>.Filter.Eq("Vehicles.RegistrationNo", registrationNumber);
            var result = _Users.Find(filter).FirstOrDefaultAsync();
            return result;
        }
        ...
        public virtual Task<TUser> FindByReferralCodeAsync(string referralCode)
        {
            return _Users.Find(u => u.ReferralCode == referralCode).FirstOrDefaultAsync();
        }
        ...
        public virtual Task<TUser> FindByProfileNameAsync(string profileName)
        {
            return _Users.Find(u => u.ProfileName == profileName).FirstOrDefaultAsync();
        }
    }
}
